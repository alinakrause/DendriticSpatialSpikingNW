...
for sigmarec = sigmarec_values
    disp(sprintf('sigmarec %.2f', sigmarec));
    ...
    %[s,IF,Ie,Ii,v,f_total,e_total,i_total,total,count,inpFut,ae1,ai1,ax1,ae2,ai2,ax2,ae3,ai3,ax3,ae4,ai4,ax4,NL,NL_after] = IF2DSpatialNetworkDendrites(sF,NF1,Ne1,Ni1,JeF,JiF,Jee,Jei,Jie,Jii,KeF,KiF,Kee,Kei,Kie,Kii,betaeF,betaiF,betaee,betaei,betaie,betaii,Cm,gl,vl,DeltaT,vT,tref,vth,vre,vlb,tausynF,tausyne,tausyni,V0,T,dt,maxns,Irecord,Irecord_i,NL_center,NL_height,NL_slope);
