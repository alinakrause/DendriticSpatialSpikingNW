    ...
    for (i = 1; i < Nt && ns < maxns; i++)
    {
        ...
        for (j = 0; j < N; j++)
        {
            ...
            *input_count += 1.0;
            ...
            double average_input_per_dendrite = -2.0; //-1.125; // 2.5; //-2.5; //-1.4; //-0.9; //-0.5; // 0.23223439321163172; // 0.2569022007446712; // broader inhibition  //0.23223439321163172; // balanced NW inhib = exit
                                                      //   - (gl[0] * (v[j] - Vleak[0]) / 4)
            ...
            double s_at_zero = applySigmoid(0.0, lambda, average_input_per_dendrite);                                                         // s(0)
            double nonlinearity_1 = 2.5 * (2 * (applySigmoid(total_input_dendrite_1, lambda, average_input_per_dendrite)) - (2 * s_at_zero)); // 4 * 1.95 *  // 2.3 std or 2*2.3
            double nonlinearity_2 = 2.5 * (2 * (applySigmoid(total_input_dendrite_2, lambda, average_input_per_dendrite)) - (2 * s_at_zero));
            double nonlinearity_3 = 2.5 * (2 * (applySigmoid(total_input_dendrite_3, lambda, average_input_per_dendrite)) - (2 * s_at_zero));
            double nonlinearity_4 = 2.5 * (2 * (applySigmoid(total_input_dendrite_4, lambda, average_input_per_dendrite)) - (2 * s_at_zero));
            ...
            double centered_sigmoid2 = total_input_current; // nonlinearity;
